 ...
 */
final class Version20230626155739 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE enterprise (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, offers_id INT DEFAULT NULL, status_id INT NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, email VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_B1B36A03A76ED395 (user_id), INDEX IDX_B1B36A03A090B42E (offers_id), INDEX IDX_B1B36A036BF700BD (status_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
